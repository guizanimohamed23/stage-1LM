  ...
  return (
    <Box sx={{ display: "flex", justifyContent: "center", marginBottom: '5rem' }}>
      <Grid container marginTop={"3rem"} spacing={2} xs={12}>
        <Grid item size={{ xs: 6, md: 3 }} sx={{ display: "flex", justifyContent: "center" }}>
          <Card sx={{ minHeight: '225px', bgcolor: "#EAEEF0", borderRadius: ".7rem" }}>
            <Box sx={{ display: "flex", alignItems: "center", justifyContent: "center", marginTop: "1rem" }}>
              <AccountBalanceIcon
                sx={{ bgcolor: "#5B99C2", color: "white", fontSize: "3rem", borderRadius: "3rem", padding: ".5rem" }}
              />
            </Box>
            <CardContent>
            ...
            <CardActions sx={{ display: "flex", justifyContent: "center" }}>
              <Button sx={{ bgcolor: "#1A4870", borderRadius: "2rem", color: "white" }}>
                {t('cards.view_more')}
              </Button>
            </CardActions>
          </Card>
