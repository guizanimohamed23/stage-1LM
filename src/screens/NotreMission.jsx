      ...
      <Fade in={fadeIn} timeout={1000}>
        <Box>
              ...
              <TabContext value={value1}>
                ...
                <Box sx={{ display: "flex", justifyContent: "center" }}>
                  <TabPanel value="1">
                    ...
                    * les projets de textes réglementaires tendant à imposer des
                    conditions particulières régissant les <br />
                    activités économiques <br />
                    * Les projets de concentration <br />
                    * Exonération de certaines pratiques au sens de l’article 6
                  ...
                  <TabPanel value="2">
                    ...
                    * les projets de textes législatifs et toutes les questions
                    qui touchent la concurrence.
                    <br />
                    * Qui peut saisir le Conseil ? le ministre chargé du
                    commerce.
                    <br />
                    2-2 domaine de compétences :<br />
                    * l’avis du Conseil sur les questions de concurrence
                    <br />
                  </TabPanel>
                  <TabPanel value="3">
                    * les organismes ou groupements de consommateurs légalement
                    établis
                    <br />
              ...
              <TabContext value={value2}>
                <Box sx={{ display: "center", justifyContent: "center" }}>
                  ...
                  >
                    ...
                    <Tab
                      label="Qui peut saisir le conseil concernant le volet juridictionnel ?"
                      value="5"
                    />
                  </TabList>
                </Box>
                <Box sx={{ display: "center", justifyContent: "center" }}>
                  <TabPanel value="4">
                    1- Actions concertées, les collusions et les ententes
                    expresses ou tacites ayant un effet ou objet
                    anti-concurrentiel <br />
                    2- Exploitation abusive d’une position dominante <br />
                    3- Exploitation abusive d’un état de dépendance économique{" "}
                    <br />
                  ...
                  <TabPanel value="5">
                    ...
                    5- Organismes et groupements de consommateur légalement
                    établis <br />
          ...
          <Box>
            ...
            <Typography>
              1 - Loi n° 2015-36 du 15 septembre 2015, relative à la
              réorganisation de la concurrence et des prix.
            </Typography>
            <Typography marginTop={"1rem"}>
              {" "}
              2 - Décret n° 2006-477 du 15 février 2006, fixant les modalités
              d’organisation administrative et financière et de fonctionnement
